...
"}")
    ...
    def retranslateUi(self, splash_screen):
        ...
        self.lbl_title.setText(QCoreApplication.translate("splash_screen", u"<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; color:#ffffff;\">NOME SISTEMA</span></p></body></html>", None))
