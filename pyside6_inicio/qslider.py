...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        #self.qslider.setMinimum(-10)
        #self.qslider.setMaximum(10)
        self.qslider.setRange(-10,10)

        self.qslider.valueChanged.connect(self.value_changed)
        self.qslider.sliderMoved.connect(self.slider_position)
        self.qslider.sliderPressed.connect(self.slider_pressed)
